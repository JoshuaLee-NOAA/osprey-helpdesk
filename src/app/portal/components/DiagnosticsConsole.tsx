  ...
  return (
    <div className="w-80 h-[82vh] min-h-[480px] max-h-[850px] bg-background border border-border rounded-2xl flex flex-col shadow-md overflow-hidden animate-in slide-in-from-right duration-300 shrink-0 text-slate-800">
      ...
      <div className={cn(
        ...
        {/* Collapsible Content */}
        {isConsoleExpanded && (
          <div className="px-5 pb-5 flex flex-col gap-4 animate-in slide-in-from-bottom duration-300 flex-1 overflow-y-auto border-t border-border/40 pt-4 min-h-0">
            ...
            {/* Timeline component */}
            <div className="flex flex-col gap-4 pl-3 border-l border-slate-200 ml-1.5">
              {toolCalls.length === 0 ? (
